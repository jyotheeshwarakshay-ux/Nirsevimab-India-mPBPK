...
I developed this project during my 5th year PharmD because I kept seeing the same problem in clinical practice: nirsevimab dosing recommendations are based entirely on Western data, yet Indian infants — especially low-birth-weight and preterm babies — follow very different growth trajectories. The Indian Academy of Pediatrics (IAP) 2015 LMS standards capture these patterns, but no one had built a model that actually used them.

This project integrates real IAP 2015 LMS growth parameters with Z-score variability, dynamic allometric scaling, weight-banded dosing, quasi-steady-state target-mediated drug disposition (QSSA-TMDD), and time-dependent viral escape dynamics. It also includes a fully functional interactive Shiny dosing simulator so the results can actually be used at the bedside.

## Key Results
- Achieved **90.5%** probability of target attainment (PTA > 0.1 mg/L at Day 150) with standard weight-banded dosing (50 mg if birth weight < 5 kg, 100 mg otherwise) across 5,000 virtual Indian infants.
